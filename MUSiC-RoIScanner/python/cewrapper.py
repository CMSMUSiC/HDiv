...
parser.add_argument("-e", "--executable", type=str, help="Path to the executable")
group = parser.add_mutually_exclusive_group()
splitting_group = group.add_argument_group(
    title="splitting arguments", description=None
)

group.add_argument(
    "--splitting", default="splitting.json", type=str, help="Path to splitting json"
)
splitting_group.add_argument("--input-json", type=str, help="Path to splitting json")
splitting_group.add_argument(
    "--first-round", default=-1, type=int, help="Path to splitting json"
)
splitting_group.add_argument(
    "--nrounds", default=1, type=int, help="Path to splitting json"
)
parser.add_argument(
    "-s",
    "--shifts",
